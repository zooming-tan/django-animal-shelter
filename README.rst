...
.. code-block:: bash
    ...
    cd django-animal-shelter
    celery -A django-animal-shelter.taskapp worker -l info
...
To run the tests, enter the django-animal-shelter/tests directory and run the following commands::
